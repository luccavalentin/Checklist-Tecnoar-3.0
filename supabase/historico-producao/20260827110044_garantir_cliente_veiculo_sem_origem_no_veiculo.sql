-- Migração aplicada em produção (projeto zdhebeqlhynffxfmedvj), versão 20260827110044.
-- Exportada de supabase_migrations.schema_migrations: é o registro do que rodou. Não edite.

-- `veiculos` não tem coluna `origem`: veículo não existe na Omie, é cadastro
-- só da oficina. Só o cliente entra na fila de envio ao ERP.
