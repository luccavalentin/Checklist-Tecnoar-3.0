...
export const NAVEGACAO: GrupoMenu[] = [
  ...
  {
    /* Logo abaixo do Início: a central de socorros precisa estar a um toque
       de qualquer lugar. E o SOS é gerido daqui: o Checklist é o sistema-mãe (clientes, veículos,
       mecânicos, produtos, serviços e OS), e cada área do socorro tem a sua
       entrada — a central não fica escondida atrás de abas. */
    id: 'sos',
    rotulo: 'SOS Tecnoar',
    itens: [
      { rotulo: 'Central ao vivo', rota: '/sos', icone: Siren, etapa: 15, recurso: 'sos' },
      { rotulo: 'Chamados', rota: '/sos/chamados', icone: LayoutList, etapa: 15, recurso: 'sos' },
      { rotulo: 'Mecânicos em campo', rota: '/sos/mecanicos', icone: HardHat, etapa: 15, recurso: 'sos' },
      { rotulo: 'Clientes do app', rota: '/sos/clientes', icone: Smartphone, etapa: 15, recurso: 'sos' },
      { rotulo: 'Contratos e SLA', rota: '/sos/contratos', icone: Handshake, etapa: 15, recurso: 'sos' },
      { rotulo: 'Agendamentos', rota: '/sos/agendamentos', icone: CalendarClock, etapa: 15, recurso: 'sos' },
      { rotulo: 'Peças e serviços', rota: '/sos/catalogo', icone: PackageSearch, etapa: 15, recurso: 'sos' },
      { rotulo: 'Relatórios SOS', rota: '/sos/relatorios', icone: BarChart3, etapa: 15, recurso: 'sos' },
      { rotulo: 'Configurações SOS', rota: '/sos/configuracoes', icone: SlidersHorizontal, etapa: 15, recurso: 'sos' },
    ],
  },
  {
    id: 'cadastros',
