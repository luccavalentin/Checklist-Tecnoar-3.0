  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-2">
        ...
        {/* Icon container */}
        <div
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-all duration-300 group-hover:scale-105"
          style={{
      ...
      {/* Bottom progress bar */}
      <div className="absolute bottom-0 left-2 right-2 h-[2px] rounded-full bg-[var(--line)]/20">
        <div
